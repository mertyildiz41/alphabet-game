// src/alphabet-arrow-game/AlphabetArrowGameUI.ts
...
export class AlphabetArrowGameUI {
    ...
    private drawLetter(letterObj: LetterDrop) {
    ...
    private drawArrow(arrow: Projectile) {
    ...
    public showWinScreen(score: number) {
