...
if (alphabetShooterGameBox && landingPage && alphabetGameContainer) {
    alphabetShooterGameBox.addEventListener('click', () => {
        ...
        if (snakeGameContainer) snakeGameContainer.classList.add('hidden'); // Hide other game container
...
if (snakeGameBox && landingPage && snakeGameContainer) {
    snakeGameBox.addEventListener('click', () => {
        ...
        if (alphabetGameContainer) alphabetGameContainer.classList.add('hidden'); // Hide other game container
        document.body.style.overflow = 'hidden';
        initializeSnakeGame();
    });
}
